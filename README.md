...
```md
![Conversation list and filters](docs/screenshots/list-and-filters.png)
![Conversation view with tags and notes](docs/screenshots/conversation-view.png)
![Tag manager panel](docs/screenshots/tag-manager.png)
```
